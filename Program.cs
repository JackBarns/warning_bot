...
namespace new_bot
{
    class Program {
        ...
        public async Task RunBotAsync()
        {
            ...
            await _client.SetGameAsync("!help - Find A Team: Tarkov v2.0");
        ...
        private async Task HandleCommandAsync(SocketMessage arg)
        {
            ...
            if (_sqlHandler.IsBotChannel(message.Channel.Id) == false || message is null) { return; }
            if (message.Author.IsBot == true) { await message.DeleteAsync(); return; }


            _sqlHandler.log_logLine($"  Author: {message.Author}" + Environment.NewLine +
